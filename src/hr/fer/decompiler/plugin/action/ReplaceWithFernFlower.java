...
public class ReplaceWithFernFlower extends AnAction {
    public ReplaceWithFernFlower() {
            ...
            ProgressManager.getInstance().run(new Task.Backgroundable(project, "Copying files") {
                public void run(ProgressIndicator indicator) {
                    ...
                    if (!selectedFile.isDirectory()) {
                        ...
                        String fileToBeCopied = projectPath + Utils.fernflowerOutput + "/" + filePath;
                        ...
                        String dirToBeCopied = projectPath + Utils.fernflowerOutput + "/" + filePath;
